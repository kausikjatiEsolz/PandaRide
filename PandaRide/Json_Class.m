...
//    [op start];
   ...
   NSURLSessionUploadTask *uploadTask_data = [manager uploadTaskWithStreamedRequest:request  progress:^(NSProgress * _Nonnull uploadProgress) {
